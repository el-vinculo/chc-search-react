...
function SearchResults({ data }) {
  const [activeRecord, setActiveRecord] = useState(data[0]);
  ...
  return (
    <div className="search-results-container">
        ...
        {_uniqBy(data, 'id').map((row) => (
          <div
            className={`record-row ${
              activeRecord.Programs.ProgramName === row.Programs.ProgramName
                ? 'active'
                : ''
            }`}
      ...
      <div className="records-detail">
        ...
        <p>
          {_get(activeRecord, 'OrganizationName.OrganizationName[0].Text', '')}
        </p>
        ...
        <p>{activeRecord.Programs.ProgramDescriptionDisplay}</p>
        <h3>Populations</h3>
        <p>
          ...
          <>
            ...
            <div className="address-wrap">
              ...
              {!_isEmpty(activeRecord.OrgSites[0].Name) && (
                <div>
                  <PersonIcon size="small" /> {activeRecord.OrgSites[0].Name}
                </div>
              )}
